...
searchPath = strcat(filePath, 'data', filesep, 'SupFigure8c');
searchTerm = 'SupFigure8c_EMXJ13_meanPSA.mat'; 
savePath = strcat(filePath, filesep, 'plots', filesep, 'SupFigure8c', filesep);
fileNamePrefix = 'SupFigure8c';
...
legend boxoff  
imgName = strcat(savePath, filesep, fileNamePrefix, '_mean_PSA_regression_before_vs_after_step-wise');
savefig(imgName)
