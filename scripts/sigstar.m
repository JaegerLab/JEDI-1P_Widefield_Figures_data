function varargout=sigstar(groups,stats, limY, nosort)
    % sigstar - Add significance stars to bar charts, boxplots, line charts, etc,
    % Rob Campbell (2023). raacampbell/sigstar (https://github.com/raacampbell/sigstar), GitHub. Retrieved August 1, 2023.
...
function H=makeSignificanceBar(x,y,p)
    ...
    H(1)=plot(x(:),y,'-k','LineWidth',0.75,'Tag','sigstar_bar', 'HandleVisibility','off');
    ...
    H(2)=text(mean(x(:)),starY * 1.04,stars,...
